    ...
    <ul>
        <li>
            <ul style="display: flex;">
                ...
                <a href="Dashboard.php">
                    <P style="font-size: 12px;font-weight:500; margin-left:10px;">DASHBOARD</P>
                </a>
            </ul>
        </li>
        <li>
        ...
        <li>
            <div class="" style="display: flex;align-items:center">
                ...
                <P style="font-size: 12px;font-weight:500;margin-left:10px;">PERSONNEL AND DEPARTMENTS</P>
            </div>
            <ul>
                <li><a href="../admin/employee.php">EMPLOYEE</a></li>
                <li><a href="../admin/position.php">EMPLOYEE POSITION</a></li>
